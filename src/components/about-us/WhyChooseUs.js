...
function WhyChooseUs(props) {
    const WhyChooseUs = [
        ...
        },
        {
            image: Group.src,
            title: "EXPERIENCED TEAM",
            desc: "Through our 9:00 AM to 10:00 PM functionality and free \n" +
                    ...
                    <Box py={6}>
                        <Grid container>
                            <Grid item xs={12} md={7} my={4}>
                                <Typography variant="h3" color={"#1E2452"} fontSize={'48px'} fontWeight="bold"
                                            className={"heading"} gutterBottom>
                                    WHY CHOOSE US ?
                                </Typography>
                            ...
                            <Grid item xs={12} md={8} bgcolor={"white"} position={"relative"} p={{xs: 1, md: 5}} mt={3}>
                                    ...
                                    <Box display={{sm: "flex"}} key={ind} alignItems={"center"} p={{xs: 1.5, md: 3}}>
                                        ...
                                        <Box>
                                            <Typography variant={'h6'} fontWeight={"bold"}
                                                        color={"#001D46"}>{item.title}</Typography>
                                ...
                                <Box height={"35vh"} width={"100%"} display={{xs: "none", md: "block"}}
                            ...
                            <Grid item xs={12}>
                                <Box height={"50vh"} width={"100%"} display={{xs: "block", md: "none"}} mt={3}>
                                    <img src={whyChoose.src} style={{height: "100%", width: "100%", objectFit: "cover"}}
                                         alt={"Why" +
                                             " Choose Us"}/>
                                </Box>
                            </Grid>
